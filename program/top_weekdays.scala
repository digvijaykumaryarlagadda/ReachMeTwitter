...
val mytempvar1= sqlContext.sql("SELECT 'Mon', COUNT(*) AS temptable FROM tweets WHERE created_at like '%Mon%'").collect()
val mytempvar2= sqlContext.sql("SELECT 'Tue', COUNT(*) AS temptable FROM tweets WHERE created_at like '%Tue%'").collect()
val mytempvar3= sqlContext.sql("SELECT 'Wed', COUNT(*) AS temptable FROM tweets WHERE created_at like '%Wed%'").collect()
val mytempvar4= sqlContext.sql("SELECT 'Thu', COUNT(*) AS temptable FROM tweets WHERE created_at like '%Thu%'").collect()
val mytempvar5= sqlContext.sql("SELECT 'Fri', COUNT(*) AS temptable FROM tweets WHERE created_at like '%Fri%'").collect()
val mytempvar6= sqlContext.sql("SELECT 'Sat', COUNT(*) AS temptable FROM tweets WHERE created_at like '%Sat%'").collect()
val mytempvar7= sqlContext.sql("SELECT 'Sun', COUNT(*) AS temptable FROM tweets WHERE created_at like '%Sun%'").collect()
